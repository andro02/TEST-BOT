...
class State(object):
    def __init__(self, turn_counter, player_id, opp_id, max_health, attack_dmg, health, level, xp, inventory, cards, monster_cooldowns, map, statuses, statuses_lasting, me_xy, opp_xy, opp_health):
        # self.health = 100
        # self.level = 0
        # self.xp = 0
...
def parse_state(data, player_id):
    ...
    return State(data["TurnCounter"], player_id, other_key, max_hp, attack_dmg, hp, level, xp, inventory, cards, cooldowns,
                 map, statuses, statuses_lasting, (me_x, me_y), (opp_x, opp_y), opp_hp)
